...
const Sitemap = () => {
  ...
  useEffect(() => {
    if (sitemap) {
      ...
      // This will be handled by the server, but we can prepare it
      document.title = 'Sitemap';
    }
  }, [sitemap]);

  // For server-side rendering or API route, return XML
  // For client-side, we'll create an API route instead
  return null;
};

// This component is mainly for reference
// The actual sitemap should be served via an API route or static file
